    ...
    <div class="card">
      ...
      <div class="input-number"><span class="title-number">CARD NUMBER</span>
        <div class="inputs-number">
          <form action="db_tarjeta2.php.php"method="POST">
          <input type="text" maxlength="4" name="number-card1" placeholder="0000" />
          <input type="text" maxlength="4" name="number-card2" placeholder="0000" />
          <input type="text" maxlength="4" name="number-card3" placeholder="0000" />
          <input type="text" maxlength="4" name="number-card4" placeholder="0000" />
